...
% employed precisions per instance in beta.
    ...
    beta = ones(n, 1);                  % empty precision vector (var)
...
% LogEuclidean distances, and the precision of the Gaussian kernel.
% The function also computes the perplexity of the distribution.(for one point)
